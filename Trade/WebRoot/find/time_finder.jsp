...
<html>
  ...
  <script src="<%=path %>/js/jquery-1.11.1.min.js"></script>
    ...
    <title>My JSP 'time_finder.jsp' starting page</title>
...
<form id = "searchForm" method="get" action = "time_find">
请输入合同号关键字： <input type = "text" name = "Contract_id" placeholder = "请输入关键字"/> 
